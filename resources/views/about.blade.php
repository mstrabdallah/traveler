<x-layouts.app>
   <div class="bg-primary-900 py-24 sm:py-32 relative overflow-hidden">
        <div class="absolute inset-0">
            <img src="https://images.unsplash.com/photo-1576016770557-087e5b2257d9?q=80&w=2600&auto=format&fit=crop" alt="Temple" class="h-full w-full object-cover opacity-20">
    ...
    <div class="py-24 sm:py-32 bg-white">
        <div class="mx-auto max-w-7xl px-6 lg:px-8 prose prose-lg prose-indigo text-gray-600">
            ...
            <h3>Why Choose Us?</h3>
            <ul>
                <li><strong>Expert Guides:</strong> Our Egyptologists bring history to life.</li>
                <li><strong>Curated Itineraries:</strong> We don't just visit places; we create experiences.</li>
                <li><strong>Seamless Travel:</strong> From airport pickup to drop-off, we handle everything.</li>
                <li><strong>Premium Support:</strong> 24/7 assistance throughout your trip.</li>
            </ul>
