            ...
            <div class="flex flex-col lg:flex-row gap-8">
                ...
                <div class="w-full lg:w-1/4 space-y-8">
                    <form action="{{ route('tours.index') }}" method="GET" class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700">
                        <h2 class="text-xl font-bold text-gray-900 dark:text-white mb-6 font-display">Find Your Tour</h2>
                        ...
                        <!-- Search -->
                         <div class="mb-6">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="search" value="{{ request('search') }}" placeholder="Where to?" class="pl-10 w-full rounded-lg border-gray-200 dark:border-gray-600 focus:border-accent-500 focus:ring-accent-500 bg-gray-50 dark:bg-gray-900 dark:text-white text-sm dark:placeholder-gray-500">
                            </div>
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="relative">
                                <input type="text" name="date_from" id="date_from_filter" value="{{ request('date_from') }}" class="w-full rounded-lg border-gray-200 dark:border-gray-600 focus:border-accent-500 focus:ring-accent-500 bg-gray-50 dark:bg-gray-900 dark:text-white text-sm dark:placeholder-gray-500" placeholder="Pick a date">
                        ...
                        <div class="mb-6 relative" 
                            ...
                            <div x-show="open" 
                                ...
                                <div class="flex items-center justify-between mb-6 pb-4 border-b border-gray-100 dark:border-gray-700">
                                    <span class="text-gray-700 dark:text-gray-300 font-medium"><span x-text="counts.child"></span> child</span>
                                    <div class="flex items-center gap-3">
                    ...
                    <div class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 hidden lg:block">
                        <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-4 font-display">Last Minute</h3>
                        <div class="space-y-4">
                            @foreach($tours->take(3) as $lmTour)
                                <div class="flex gap-3 items-center group cursor-pointer" onclick="window.location='{{ route('tours.show', $lmTour) }}'">
                                    ...
                                    <div>
                                        <h4 class="text-sm font-semibold text-gray-900 dark:text-white group-hover:text-accent-600 line-clamp-2 transition">{{ $lmTour->name }}</h4>
                ...
                <div class="w-full lg:w-3/4">
                    ...
                    <div class="flex flex-col sm:flex-row justify-between items-center mb-8 gap-4">
                        <p class="text-gray-600 dark:text-gray-400 text-sm"><span class="font-bold text-gray-900 dark:text-white text-lg">{{ $tours->total() }}</span> Tours found</p>
