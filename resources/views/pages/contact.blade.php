            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-20">
                ...
                <div class="lg:col-span-2 space-y-8">
                    <div>
                        ...
                        <h1 class="text-5xl font-bold text-[#345BA8]">Leave a message</h1>
                    </div>
                    ...
                    <form action="{{ route('contact.store') }}" method="POST" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <input type="text" name="name" required placeholder="Your Name" class="w-full rounded-xl border-none bg-[#f2f2f2] px-6 py-4 text-gray-700 placeholder:text-gray-500 focus:ring-2 focus:ring-yellow-400 transition">
                            
                            <input type="email" name="email" required placeholder="Email Address" class="w-full rounded-xl border-none bg-[#f2f2f2] px-6 py-4 text-gray-700 placeholder:text-gray-500 focus:ring-2 focus:ring-yellow-400 transition">
                            
                            <input type="tel" name="phone" placeholder="Phone Number" class="w-full rounded-xl border-none bg-[#f2f2f2] px-6 py-4 text-gray-700 placeholder:text-gray-500 focus:ring-2 focus:ring-yellow-400 transition">
                            
                            <input type="text" name="subject" placeholder="Subject" class="w-full rounded-xl border-none bg-[#f2f2f2] px-6 py-4 text-gray-700 placeholder:text-gray-500 focus:ring-2 focus:ring-yellow-400 transition">
                        </div>

                        <textarea name="message" required rows="8" placeholder="Write message" class="w-full rounded-xl border-none bg-[#f2f2f2] px-6 py-4 text-gray-700 placeholder:text-gray-500 focus:ring-2 focus:ring-yellow-400 transition"></textarea>
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm h-full flex flex-col justify-center">
                        <h2 class="text-4xl font-bold text-yellow-500 mb-10">Contact us</h2>
                        
                        <div class="space-y-8 mb-12">
                            <div class="flex items-center gap-4 text-[#345BA8]">
...
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-instagram-icon lucide-instagram"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/></svg>
        ...
        <!-- Full Width Map -->
        <div class="mt-20 w-full h-[500px] bg-gray-100">
            <iframe 
