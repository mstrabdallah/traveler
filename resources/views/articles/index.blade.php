<x-layouts.app>
    <div class="bg-primary-900 py-24 sm:py-32 relative overflow-hidden">
        <div class="absolute inset-0">
            <img src="https://images.unsplash.com/photo-15422596594ab-d748ce6663f7?q=80&w=2670&auto=format&fit=crop" alt="Blog Background" class="h-full w-full object-cover opacity-20">
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-3">
                @foreach($articles as $article)
                    <article class="flex flex-col items-start justify-between bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden group border border-gray-100 h-full">
                        ...
                        <div class="max-w-xl p-6 flex flex-col flex-1">
                            ...
                            <div class="group relative flex-1">
                                <h3 class="mt-3 text-lg font-semibold leading-6 text-primary-900 group-hover:text-accent-600 transition-colors">
                                    <a href="{{ route('articles.show', $article) }}">
                            ...
                            <div class="mt-6 flex items-center gap-x-4 border-t border-gray-100 pt-4 w-full">
                                <a href="{{ route('articles.show', $article) }}" class="text-sm font-semibold text-accent-600 hover:text-accent-500">Read more <span aria-hidden="true">&rarr;</span></a>
                            </div>
                        </div>
                    </article>
                @endforeach
