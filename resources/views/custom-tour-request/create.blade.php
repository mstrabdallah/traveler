<x-layouts.app>
    ...
    <div class="relative bg-primary-950 py-20 lg:py-32 overflow-hidden">
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 text-center">
            <h1 class="text-4xl lg:text-5xl font-display font-bold text-white mb-6">Tailor-Made Your Experience</h1>
            <p class="text-xl text-gray-300 max-w-2xl mx-auto leading-relaxed">Customize every detail of your Egyptian adventure. Tell us your preferences, and let our experts craft the perfect itinerary for you.</p>
        </div>
    </div>
                ...
                <div class="p-8 lg:p-16">
                    @if(session('success'))
                        <div class="text-center py-12">
                            ...
                            <h2 class="text-3xl font-display font-bold text-gray-900 mb-4">Request Received!</h2>
                    ...
                    @else
                        <form action="{{ route('custom-tour.store') }}" method="POST" class="space-y-12" id="inquiryForm">
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    <div class="space-y-1">
                                        ...
                                        <input type="text" name="name" id="name" required class="block w-full rounded-xl border-gray-200 bg-gray-50 px-4 py-3.5 text-gray-900 focus:border-accent-500 focus:bg-white focus:ring-accent-500 transition duration-200" placeholder="John Doe">
                                    </div>
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                                    <div class="col-span-1 md:col-span-2 space-y-1">
                                        <label for="request_title" class="block text-sm font-semibold text-gray-700">Trip Name / Idea (Optional)</label>
                                        <input type="text" name="request_title" id="request_title" placeholder="e.g. Honeymoon, Family Vacation, Historical Tour" class="block w-full rounded-xl border-gray-200 bg-gray-50 px-4 py-3.5 text-gray-900 focus:border-accent-500 focus:bg-white focus:ring-accent-500 transition duration-200">
                                    </div>

                                    <div class="relative space-y-1">
                                        <label for="arrival_date" class="block text-sm font-semibold text-gray-700">Planned Arrival</label>
                                        <div class="relative">
                                    ...
                                    <div class="relative space-y-1">
                                        <label for="departure_date" class="block text-sm font-semibold text-gray-700">Planned Departure</label>
                                        <div class="relative">
                                ...
                                <div class="bg-gray-50 rounded-2xl p-6 border border-gray-100" x-data="{ adults: 2, children: 0 }">
                                    <label class="block text-sm font-semibold text-gray-700 mb-4">Who is traveling?</label>
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                        <div>
                                            <span class="text-xs font-medium text-gray-500 uppercase tracking-wider block mb-2">Adults (12+)</span>
                                        ...
                                        <div>
                                            <span class="text-xs font-medium text-gray-500 uppercase tracking-wider block mb-2">Children (0-11)</span>
                                            <div class="flex items-center bg-white rounded-lg border border-gray-200 p-1">
                                         ...
                                         <div class="space-y-1">
                                            <span class="text-xs font-medium text-gray-500 uppercase tracking-wider block mb-2">Ages (Optional)</span>
                                            <input type="text" name="ages_range" placeholder="e.g. 25, 30, 7" class="block w-full rounded-lg border-gray-200 bg-white px-4 py-2.5 text-gray-900 focus:border-accent-500 focus:ring-accent-500 text-sm h-[50px]">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="space-y-8">
                                    <div>
                                         <label class="block text-sm font-semibold text-gray-700 mb-4">Destinations of Interest</label>
                                             ...
                                             @foreach(['Cairo', 'Luxor', 'Aswan', 'Hurghada', 'Sharm El Sheikh', 'Alexandria', 'Siwa Oasis', 'Nile Cruise'] as $place)
                                                <label class="cursor-pointer group relative">
                                                    ...
                                                    <div class="p-4 rounded-xl border-2 border-gray-100 bg-gray-50 peer-checked:border-accent-500 peer-checked:bg-accent-50 transition-all duration-200 hover:border-accent-200 text-center">
                                                        <span class="block text-sm font-medium text-gray-700 peer-checked:text-accent-700 group-hover:text-accent-600">{{ $place }}</span>
                                                    </div>
                                    ...
                                    <div>
                                        <label for="accommodation" class="block text-sm font-semibold text-gray-700 mb-2">Preferred Accommodation Level</label>
                                             ...
                                             <label class="relative flex cursor-pointer rounded-xl border border-gray-200 bg-white p-4 shadow-sm focus:outline-none hover:border-accent-500">
                                                ...
                                                <span class="flex flex-1">
                                                  <span class="flex flex-col">
                                                    <span class="block text-sm font-medium text-gray-900 peer-checked:text-accent-600">Luxury (5 Star Ultra)</span>
                                                    <span class="mt-1 flex items-center text-sm text-gray-500">Top-tier comfort & service</span>
                                                  </span>
                                                </span>
                                               ...
                                               <label class="relative flex cursor-pointer rounded-xl border border-gray-200 bg-white p-4 shadow-sm focus:outline-none hover:border-accent-500">
                                                ...
                                                <span class="flex flex-1">
                                                  <span class="flex flex-col">
                                                    <span class="block text-sm font-medium text-gray-900 peer-checked:text-accent-600">Gold (5 Star Standard)</span>
                                                    <span class="mt-1 flex items-center text-sm text-gray-500">Great balance of quality</span>
                                                  </span>
                                                </span>
                                                <span class="pointer-events-none absolute -inset-px rounded-xl border-2 border-transparent peer-checked:border-accent-500" aria-hidden="true"></span>
                                              </label>
                                               ...
                                               <label class="relative flex cursor-pointer rounded-xl border border-gray-200 bg-white p-4 shadow-sm focus:outline-none hover:border-accent-500">
                                                ...
                                                <span class="flex flex-1">
                                                  <span class="flex flex-col">
                                                    <span class="block text-sm font-medium text-gray-900 peer-checked:text-accent-600">Silver (4 Star)</span>
                                                    <span class="mt-1 flex items-center text-sm text-gray-500">Cost-effective comfort</span>
                                                  </span>
                                                </span>
                                                <span class="pointer-events-none absolute -inset-px rounded-xl border-2 border-transparent peer-checked:border-accent-500" aria-hidden="true"></span>
                                              </label>
                                               ...
                                               <label class="relative flex cursor-pointer rounded-xl border border-gray-200 bg-white p-4 shadow-sm focus:outline-none hover:border-accent-500">
                                                ...
                                                <span class="flex flex-1">
                                                  <span class="flex flex-col">
                                                    <span class="block text-sm font-medium text-gray-900 peer-checked:text-accent-600">Bronze (3 Star)</span>
                                                    <span class="mt-1 flex items-center text-sm text-gray-500">Just the essentials</span>
                                                  </span>
                                                </span>
                                                <span class="pointer-events-none absolute -inset-px rounded-xl border-2 border-transparent peer-checked:border-accent-500" aria-hidden="true"></span>
                                              </label>
                            ...
                            <div>
                                ...
                                <div class="space-y-6">
                                    <div>
                                        <label for="notes" class="block text-sm font-semibold text-gray-700 mb-2">Any specific requirements or notes?</label>
                                        <textarea name="notes" id="notes" rows="4" class="block w-full rounded-xl border-gray-200 bg-gray-50 px-4 py-3.5 text-gray-900 focus:border-accent-500 focus:bg-white focus:ring-accent-500 transition duration-200" placeholder="Tell us more about what you're looking for..."></textarea>
                                    </div>
        
                                    <div>
                                        <label class="block text-sm font-semibold text-gray-700 mb-3">How did you find us? (Optional)</label>
                            ...
                            <div class="pt-6">
                                ...
                                <p class="text-center text-sm text-gray-500 mt-4">One of our agents will contact you within 24 hours.</p>
                            </div>
